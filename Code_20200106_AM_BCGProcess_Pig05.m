...
title(['pig: ',num2str(pigNo),'  Abs: ',num2str(eveNo)])
ylabel('BCG Acc')
...
ylabel('BCG Disp')
saveas(gcf,['C:\Users\sumbu\Documents\Research\data\Fig_Pig_',num2str(pigNo),'_Abs_',num2str(eveNo),'.png'])
...
% save(['D:\Project-AHA\Data For GUI\pig05Data_Rel',num2str(eveNo)],'data')
save(['C:\Users\sumbu\Documents\Research\data\pig05Data_Abs',num2str(eveNo)],'data')
end
%%
